...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/helmet/helmet-count-list/helmet-count-list.module').then( m => m.HelmetCountListPageModule)
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/belt/belt-collection-data/belt-collection-data.module').then( m => m.BeltCollectionDataPageModule)
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/belt/belt-count-list/belt-count-list.module').then( m => m.BeltCountListPageModule)
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/general/general-count-colection-data/general-count-colection-data.module').then( m => m.GeneralCountColectionDataPageModule)
  },
  // {
  ...
  // },
  {
    ...
    loadChildren: () => import('./pages/general/general-count-count-list/general-count-count-list.module').then( m => m.GeneralCountCountListPageModule)
  },
  {
