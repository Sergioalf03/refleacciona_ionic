...
const QUESTION_ROWS: Array<Array<any>> = [
  ...
  [1, '5',    0, 'S-1-4-1',1,  5, 1, 'Número de carriles',                      'ONEDIGIT',   ''],
  [1, '5',    0, 'S-1-4-2',1,  5, 1, 'Número de carriles por sentido',          'ONEDIGIT',   ''],

  [2, 'S1',   0, 'E-1-3',  1,  1, 1, '¿Cuál es la velocidad máxima permitida?',                                                                           `${JSON.stringify([{v:1,t:'AC < 80 km/h'},{v:2,t:'AV < 50 km/h'},{v:3,t:'CO < 40 km/h'},{v:4,t:'LO <30 km/h'}])}`, ''],
  [2, 'S2',   0, '',       1,  2, 1, '¿Cuenta con señales de reducción de velocidad?',                                                                    `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      'Marcas en pavimento o señales'],
  [2, 'S3.1', 0, 'D-1-5-<:3:2:1',       1,  3, 1, '¿Cuenta con menos de 3 carriles contando franja de estacionamiento?',                                               `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      ''],
  ...
  [2, 'S5.2', 0, 'S-2-S5.1-1',  1,  8, 1, 'En caso de existir cocheras, ¿estas tienen una longitud de 6 metros o menos?',                                 `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      ''],
  [2, 'S5.3', 0, 'S-2-S5.1-1',  1,  9, 1, '¿La banqueta mantiene su nivel en los accesos a cocheras?',                                                    `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      ''],
  [2, 'S5.4', 1, 'S-2-S5.1-1',  1, 10, 1, '¿Los accesos a las cocheras son seguros?',                                                                     `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      ''],
  ...
  [2, 'S10',  1, '',       1, 15, 1, '¿Hay líneas peatonales visiblemente pintadas para cruzar las calles?',                                              `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      ''],
  [2, 'S11',  1, '',       1, 16, 1, '¿La gente cruza por los pasos peatonales o lo hace por cualquier lado de la calle?',                                `${JSON.stringify([{v:1,t:'Si, cruza por los pasos peatonales,'},{v:2,t:'No, cruza indistintamente por cualquier lado de la calle.'}])}`,      ''],

  [3, 'S12',  1, '',       1,  1, 1, '¿Existen semáforos que prioricen el cruce de los peatones?',                            `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      'Semáforo en avenida primaria o colectora'],
  [3, 'S13',  1, '',       1,  2, 1, '¿La geometría de las esquinas prioriza el cruce por encima del giro de los vehículos?', `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      'Radio de giro < 6 metros [sujeto a la geometría vial'],
  [3, 'S14',  1, '',       1,  3, 1, '¿El número de carriles en cada una de las calles que se intersectan es menor a 3?',     `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      'Carriles que se cruzan de manera continua < 3'],
  [3, 'S15',  1, '',       1,  4, 1, '¿Las esquinas cuentan con protecciones para peatones? (Bolardos)',                      `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      'Bolardos en esquinas de avenidas primarias'],
  [3, 'S16',  1, '',       1,  5, 1, '¿El área de la intersección ofrece una libre perspectiva visual?',                      `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      'Todas las esquinas sin obstáculos a la visibilidad'],
  [3, 'S17',  1, '',       1,  6, 1, '¿El área de la intersección cuenta con iluminación nocturna?',                          `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      'Todos los cruces peatonales con iluminación nocturna'],
  ...
  [6, 'CO6', 1, 'S-6-CO5-1',  1,  6, 1, '¿Las paradas de transporte público tienen una techumbre que proteja adecuadamente del sol y la lluvia?',   `${JSON.stringify([{v:1,t:'Sí'},{v:2,t:'No'}])}`,      'Paradas de transporte público con techo'],
